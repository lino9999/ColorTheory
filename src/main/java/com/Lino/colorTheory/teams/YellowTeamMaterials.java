...
public class YellowTeamMaterials {
    public static Set<Material> getMaterials() {
        ...
        materials.add(Material.WALL_TORCH);
        ...
        materials.add(Material.OCHRE_FROGLIGHT);
        ...
        materials.add(Material.FIRE_CORAL_WALL_FAN);
        ...
        materials.add(Material.DEAD_FIRE_CORAL_WALL_FAN);

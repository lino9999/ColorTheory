...
public class PurpleTeamMaterials {
    public static Set<Material> getMaterials() {
        ...
        materials.add(Material.END_STONE_BRICK_WALL);
        ...
        materials.add(Material.DRAGON_WALL_HEAD);
        ...
        materials.add(Material.WITHER_SKELETON_WALL_SKULL);
